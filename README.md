...
The program will run forever until interrupted by the user using `CTRL+C`. After this interrupt, the program will stop executing ping request and graph the results of the test and display it to the user. A value of -1 will indicate that packets were lossed during that time period.
